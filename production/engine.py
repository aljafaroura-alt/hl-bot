...
class MoneyManager:
    ...
    def calculate_position_size(self, decision: Decision, wallet: Wallet) -> dict:
        ...
        if has_slot_info:
            ...
            min_margin_floor = min(min_margin_floor, free_margin)
...
class ProductionEngine:
    ...
    def execute(self, decision: Decision) -> ExecutionResult:
        ...
        if existing_position is not None:
            same_direction = existing_position.side == decision.side
            ...
            if not same_direction:
                logger.error(
                    ...
                    f"decision baru ini {decision.side.upper()} — arah beda, entry "
