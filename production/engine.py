        ...
        with self._lock:
            if provider:
                ...
                try:
                    ...
                    logger.warning("HyperliquidProvider not available, using PaperProvider")
            ...
            logger.info(f"ProductionEngine initialized: {self._config.PROVIDER} ({self._config.OPEN_MODE.value})")
