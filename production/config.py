...
class ProductionConfig:
    ...
    # Floor ABSOLUT margin per posisi, sebagai % dari total equity —
    # independen dari tier/size_mult. Tier rendah (D/C, size_mult 0.5x-1.5x)
    # sebelumnya bisa jatuh ke margin $5-14 walau equity ratusan dolar,
    # karena MIN_MARGIN_FLOOR_RATIO di atas ikut dikalikan size_mult.
    # Ini jaring pengaman terakhir: margin gak boleh di bawah persentase
    # ini dari equity, kecuali size_mult==0 (tier E/SHADOW, sengaja skip
    # entry). Tetap dijepit MAX_EXPOSURE_PCT & MAX_TOTAL_EXPOSURE_PCT di
    # atas kalau ternyata kegedean secara agregat.
    MIN_MARGIN_PCT_OF_EQUITY: float = 10.0   # Min ~10% equity per posisi
