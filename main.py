...
⚡ *Reaction*
├─ Latest: {reaction.event if reaction else 'None'}
├─ Absorption: {reaction.absorption*100:.0f}% if reaction else 'N/A'
└─ Confidence: {reaction.confidence*100:.0f}% if reaction else 'N/A'
